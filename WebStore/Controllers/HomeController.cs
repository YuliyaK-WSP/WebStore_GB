...
namespace WebStore.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            new EmployeeView { Id = 1,  Description = "Хроший сотрудник один" },
            new EmployeeView { Id = 2,  Description = "Хроший сотрудник два" },
            new EmployeeView { Id = 3,  Description = "Хроший сотрудник три" },
            new EmployeeView { Id = 4,  Description = "Хроший сотрудник четыре" },
            new EmployeeView { Id = 5,  Description = "Хроший сотрудник пять" },
